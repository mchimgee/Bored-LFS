         ...
         <div className="flex flex-col items-center justify-center h-full w-full px-2 md:px-10">
          ...
          {wallet && (
              ...
              <div className="flex flex-col md:flex-row md:space-x-14 w-full mt-10 md:mt-14">
                ...
                {
                    status && (
                        <div className={`border ${status.success ? 'border-green-500' : 'border-brand-pink-400'}  rounded-md text-start h-full px-4  py-4 w-full mx-auto mt-8 md:mt-4"`}>
                ...
                <div className="border-t border-gray-800 flex flex-col items-center mt-10 py-2 w-full">
                    ...
                    <a href={`https://rinkeby.etherscan.io/address/${config.contractAddress}#readContract`}
                    target='_blank'
